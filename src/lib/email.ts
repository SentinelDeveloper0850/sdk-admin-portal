...
export const sendPolicySignupConfirmationEmail = async (data: PolicySignupConfirmationEmailData) => {
  return sendEmail(
    data.to,
...
export const sendPolicySignupStatusUpdateEmail = async (data: PolicySignupStatusUpdateEmailData) => {
  const statusText = data.status === 'approved' ? 'Approved' :
    data.status === 'rejected' ? 'Rejected' :
      data.status === 'pending_info' ? 'Additional Information Required' :
        data.status;
...
export const sendPolicySignupAdminNotificationEmail = async (data: PolicySignupAdminNotificationEmailData) => {
  return sendEmail(
    data.to,
...
export const sendClaimSubmissionConfirmationEmail = async (data: ClaimSubmissionConfirmationEmailData) => {
  return sendEmail(
    data.to,
...
export const sendClaimStatusUpdateEmail = async (data: ClaimStatusUpdateEmailData) => {
  return sendEmail(
    data.to,
...
export const sendClaimAdminNotificationEmail = async (data: ClaimAdminNotificationEmailData) => {
  return sendEmail(
    data.to,
...
export const sendDailyActivityComplianceSummaryEmail = async (data: DailyActivityComplianceSummaryEmailData) => {
  return sendEmail(
    data.to,
...
export const sendDailyActivityLateSubmissionEmail = async (data: DailyActivityLateSubmissionEmailData) => {
  return sendEmail(
    data.to,
...
export const sendDailyAuditSubmissionConfirmationEmail = async (data: DailyAuditSubmissionConfirmationEmailData) => {
  return sendEmail(
    data.to,
...
export const sendDailyAuditDiscrepancyAlertEmail = async (data: DailyAuditDiscrepancyAlertEmailData) => {
  return sendEmail(
    data.to,
...
export const sendDailyAuditResolutionUpdateEmail = async (data: DailyAuditResolutionUpdateEmailData) => {
  return sendEmail(
    data.to,
...
export const sendTransactionImportSuccessEmail = async (data: TransactionImportSuccessEmailData) => {
  return sendEmail(
    data.to,
...
export const sendTransactionImportFailureEmail = async (data: TransactionImportFailureEmailData) => {
  return sendEmail(
    data.to,
...
export const sendTransactionSyncCompletionEmail = async (data: TransactionSyncCompletionEmailData) => {
  return sendEmail(
    data.to,
...
export const sendSystemErrorAlertEmail = async (data: SystemErrorAlertEmailData) => {
  return sendEmail(
    data.to,
...
export const sendSystemMaintenanceNoticeEmail = async (data: SystemMaintenanceNoticeEmailData) => {
  return sendEmail(
    data.to,
