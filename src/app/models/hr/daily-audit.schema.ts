...
export interface IDailyAuditSubmission {
...
export interface IDailyAudit {
  ...
  submissions: IDailyAuditSubmission[];
  date: string;
  totalAmount: number;
  reviewNotes: string[];
  status: string;
...
export const DailyAuditModel =
  mongoose.models["daily-audit"] ||
  mongoose.model("daily-audit", dailyAuditSchema);