...
PolicyCancellationRequestSchema.virtual("effectiveDateFormatted").get(
  function () {
...
PolicyCancellationRequestSchema.virtual("submittedAtFormatted").get(
  function () {
...
PolicyCancellationRequestSchema.statics.getByPolicy = function (
  policyId: string
) {
...
PolicyCancellationRequestSchema.methods.approve = function (
  reviewerId: string,
  notes?: string
) {
...
PolicyCancellationRequestSchema.methods.reject = function (
  reviewerId: string,
  notes?: string
) {
...
export const PolicyCancellationRequestModel =
  mongoose.models.policy_cancellation_requests ||
  mongoose.model<IPolicyCancellationRequest>(
    "policy_cancellation_requests",
    PolicyCancellationRequestSchema,
    "policy_cancellation_requests"
  );

export default PolicyCancellationRequestModel;
