  ...
  try {
    ...
    try {
      ...
      await createAuditLog({
        action: "prepaid-societies.import",
      ...
      console.error("Failed to write audit log for prepaid-societies import:", (e as any)?.message);
    }
    ...
    try {
      ...
      console.error("Failed to write audit log for prepaid-societies import (failure):", (e as any)?.message);
    }
