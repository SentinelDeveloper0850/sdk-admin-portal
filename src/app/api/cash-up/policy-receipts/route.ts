...
export async function POST(request: NextRequest) {
  try {
    ...
    const { success, message } = await submitCashUpSubmissionData({ submissionIdentifier, files, date, submittedAmount, notes, submittedAt, userId: user._id as unknown as string });
