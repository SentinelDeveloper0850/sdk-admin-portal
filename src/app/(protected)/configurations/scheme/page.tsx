              ...
              <div className="py-12">
                <div className="mb-6">
                  ...
                  <Paragraph className="text-md dark:text-gray-400 mb-6">
                    Scheme configurations management is currently under development.
                    This feature will allow you to manage insurance schemes,
                    policies, and benefit configurations.
                  </Paragraph>
                </div>
