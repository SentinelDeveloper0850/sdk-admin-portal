...
const EVENT_COLOR_MAP: Record<string, EventPalette> = {
    ...
    funeral_bathing: { background: "#DBEAFE", border: "#3B82F6", text: "#1E3A8A" },
    funeral_tent: { background: "#E0F2FE", border: "#0EA5E9", text: "#0F172A" },
    funeral_delivery: { background: "#FCE7F3", border: "#EC4899", text: "#831843" },
    funeral_service: { background: "#DCFCE7", border: "#22C55E", text: "#064E3B" },
...
export const getEventPalette = (event?: { type?: string; subType?: string; milestone?: string | null }): EventPalette => {
